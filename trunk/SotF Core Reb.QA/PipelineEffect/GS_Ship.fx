...
float4 GetFinalPixelColor(float2 texCoord, float3 lightTangent, float3 viewTangent)
{
	...
	//#ifndef IsDebug
		...
		finalColor += colorSample * 2.f * GetSpecularColor(lightTangent, normalTangent, viewTangent, dataSample);
	...
	//	finalColor += GetSpecularColor(lightTangent, normalTangent, viewTangent, dataSample) * SpecularScalar;
